...
int main(int argc, char **argv)
{
  ...
  #else
  std::cout << "Computation complete, outputting frequency counts to 'freq_net_cuda.csv'" << std::endl;
  
  // output
  std::fstream ofnet("freq_net_cuda.csv", std::ios::out );
